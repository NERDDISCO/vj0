...
def main():
    ...
    if pod!='0pxb4bss2jmbhg' or not re.fullmatch(r'20260918-05[a-z0-9-]*',tag):
        p.error('Only authorized Pod A and a fresh 20260918-05xx tag are allowed')
    if not 60<=args.seconds<=7200:p.error('Guard seconds must be60..7200')
